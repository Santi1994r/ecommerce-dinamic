//clase constructora de objetos
 ...
 const microAmd5 = new Producto(1, "MICROPROCESADOR CPU AMD RYZEN 5 5600 6/12 ZEN3", 3, 43900, "../images/ryzen5.png", 1);
 ...
 const ssd240gb = new Producto(7, "DISCO SOLIDO SSD 240 GB GIGABYTE SATA III GP-GSTF", 15, 5800, "../images/ssd240gb.png", 1);
 const hdd2tbSeagate = new Producto(8, "DISCO DURO HDD 2TB SEAGATE BARRACUDA SATA III", 8, 10200, "../images/hdd2tbSeagate.png", 1);
 const fuenteGamemax600w80plus = new Producto(9, "FUENTE GAMEMAX 600W VP-600 80+ BRONZE RGB", 11, 13490, "../images/fuenteGamemax600w80plus.png", 1);
 const fuenteGamemax700w = new Producto(10, "FUENTE GAMEMAX 700W VP-600 80+ BRONZE RGB", 7, 13990, "../images/fuenteGamemax700w.png", 1);
